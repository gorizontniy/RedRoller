...
- мастер добавления нового аккаунта прямо из чата: кнопка **Добавить аккаунт** запрашивает имя, рабочую директорию, файл конфига, JSON-ключ и пересоздаёт `telegram_bot_config.json`.
